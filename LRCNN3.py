...
trainloader = DataLoader(dataset=trainset, batch_size=218, shuffle=True)
...
class cnn(nn.Module):
    def __init__(self,num_classes=2):
        ...
        self.features=nn.Sequential(
            ...
            nn.Conv2d(14,46,kernel_size=3,stride=1,padding=1), 
            nn.Dropout(0.44),           
            ...
            nn.Conv2d(46,92,kernel_size=3,stride=1),
            nn.Dropout(0.44),
            nn.ReLU(inplace=True),


            nn.Conv2d(92,184,kernel_size=3,stride=1),
            nn.Dropout(0.44),
            nn.ReLU(inplace=True),
        ...
        self.classifier=nn.Sequential(
            ...
            ,
            nn.Linear(184*5*5,732),
            nn.Dropout(0.56),
            nn.ReLU(inplace=True),
            
                       
            nn.Linear(732,num_classes),
...
for epoch in range(50):
    ...
    torch.save(net, r'D:\doctor\dalunwen\3D\saveCNN'+"/"+str(epoch+1)+".pth")
...
plt.ylabel('accuracy/loss33A',font2)
